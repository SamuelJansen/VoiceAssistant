    ...
    def __init__(self,
        ...
        if self.mode == Globals.PROPER_WAY_TO_IMPLEMENT_IT :
            ...
            if self.printStatus :
                ...
                settingsTreeName = f'{self.__class__.__name__} settings tree'
                self.printTree(self.settingTree,settingsTreeName)
            ...
            if self.printStatus :
                ...
                {self.__class__.__name__}.apisPath =                    {self.apisPath}
                {self.__class__.__name__}.extension =                   {self.extension}\n''')
                self.printTree(self.apisTree, f'{self.apiName} Api tree list')
    ...
    def makeApisAvaliable(self) :
        ...
        if self.printStatus :
            for apiTree in self.apisTree :
                print()
                self.printTree(apiTree,'Api path tree')
            print()
